...
export default function Stepper({
  ...
  return (
    <div
      className="flex min-h-auto flex-1 flex-col items-center justify-center p-4 sm:aspect-[4/3] md:aspect-[3/1]"
      {...rest}
    >
      <div
        className={`mx-auto z-10 w-full max-w-[80%] rounded-4xl shadow-xl ${stepCircleContainerClassName}`}
