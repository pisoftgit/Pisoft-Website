      ...
      >
        {items.map((item) => (
          <li
            ...
            className="relative w-[320px] max-w-full shrink-0 rounded-xl bg-blue-950 px-6 py-5 md:w-[400px] shadow-md border border-gray-200 transition-transform duration-300 hover:scale-105 hover:bg-[#e38724]"
          >
