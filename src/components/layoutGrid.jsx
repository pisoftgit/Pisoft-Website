...
export const LayoutGrid = ({ cards }) => {
  ...
  return (
    <div className="w-full text-center md:h-full h-1/2 grid md:grid-cols-3 grid-cols-2 max-w-7xl mx-auto gap-2 md:gap-4 relative px-2 sm:px-4 md:px-6 
...
const SelectedCard = ({ selected, handleInsideClick }) => {
  return (
    <div
      className="bg-blue-400 h-full w-full flex justify-center items-center text-center rounded-lg shadow-2xl relative z-[60]"
      onClick={handleInsideClick}
    >
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.6 }}
        className="h-full w-full p-4 bg-black opacity-60 z-10
