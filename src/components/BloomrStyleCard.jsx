...
const BloomrStyleCard = ({ subtitle, title, description, videoSrc, bgClass }) => {
  return (
    <div
  className={`bg-gradient-to-br ${bgClass} rounded-3xl sm:rounded-[40px] p-4 sm:p-6 md:p-4 lg:p-10 flex flex-col md:flex-row items-center md:items-start w-full h-full shadow-lg m-5`}
>
      {/* Left: Video */}
      <div className="w-full md:w-1/3 mt-6 sm:mt-8 md:mt-12 mr-4  sm:ml-3 ml-0 sm:mr-4">
        <video
          ...
          loop
          playsInline
          className="rounded-2xl sm:rounded-[32px] w-full h-[150px] sm:h-[200px] md:h-[250px] object-cover shadow-2xl transition-all duration-500"
        />
      </div>
