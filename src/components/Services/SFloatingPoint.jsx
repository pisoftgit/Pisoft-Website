...
const blogContents = [
    {
        ...
        description:
            "You can manage transportation system to ensure smoother movement in school, college or any organisation having their fleet of vehicle of any classification.",
        image: "https://img.freepik.com/free-vector/people-fueling-car-with-gasoline_53876-59864.jpg?semt=ais_hybrid&w=740"
    },
    {
        slug: "service-package-management",
        ...
        image: "https://png.pngtree.com/thumb_back/fh260/background/20231006/pngtree-d-render-concept-efficient-product-delivery-service-with-courier-transportation-and-image_13533986.png"
    },
    {
        slug: "tour-booking-management",
        title: "Tour Booking Management",
        description:
            "System meant for managing tour schedule and booking individual seat ticket sale. Helps in managing booking and cancelation process etc.",
        image: "https://img.freepik.com/free-photo/top-view-travel-elements-collection_23-2148691133.jpg?semt=ais_hybrid&w=740"
    },
    {
        slug: "vehicle-booking-management",
        title: "Vehicle Booking Management",
        description:
            "System is developed to manage all cab hiring, useful for vehicle booking agency that are specialized in Hiring vehicle to customers. Using this system it is very easy to book a vehicle and agency can also track their booking. It is a system through which one can view available vehicle, register it in the system, view profile and book vehicle.",
        image: "https://img.freepik.com/free-vector/taxi-app-concept-illustration_52683-36028.jpg"
    },
    {
    ...
    },
    {
        ...
        description:
            "A complete module to calculate commissions for various levels in hierarchy that can be configured for automatic calculation and disbursal for ease and accurate calculations.",
    ...
    },
    {
        ...
        image: "https://img.freepik.com/premium-vector/technology-isometric-crm-illustration_23-2149375821.jpg?semt=ais_hybrid&w=740"
    },
    {
