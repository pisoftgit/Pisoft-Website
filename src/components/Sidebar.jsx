      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "fixed h-full w-full inset-0 bg-white p-10 z-[100] flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-orange-600 scrollbar-track-gray-800",
              className
            )}
          >
            <div
...
export const SidebarLink = ({ link, className, ...props }) => {
  ...
  return (
    <a
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 py-2 rounded-md px-2 hover:bg-orange-600/40 transition-all duration-150 group/sidebar font-jSB text-orange-300",
        className
      )}
      {...props}
    >
