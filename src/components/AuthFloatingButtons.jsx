  ...
  return (
    <div className="fixed bottom-4 right-2 z-[1000] gap-2 bg-transparent flex flex-row p-2">
      ...
      >
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-blue-950 px-4 py-2 text-sm font-medium text-white backdrop-blur-3xl">
          Take a test
        </span>
      </button>
