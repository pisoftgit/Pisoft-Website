...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white px-6 sm:px-12 md:px-24 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-14 border-b border-gray-700 pb-12">
        ...
        <div className="flex flex-col items-center sm:items-center text-center sm:text-center">
          ...
          <address className="not-italic text-gray-400 text-sm sm:text-base space-y-2 leading-relaxed">
      ...
      {/* Footer Bottom */}
      <div className="mt-10 text-center text-xs sm:text-sm text-gray-500 tracking-wider">
        © {new Date().getFullYear()} <span className="text-white font-semibold">Your IT Company</span>. All rights reserved.
      </div>
    </footer>
  );
};
