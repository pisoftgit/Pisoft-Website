...
export default function LoginUser() {
  ...
  return (
    <main className="relative flex items-center justify-center w-full h-screen overflow-hidden">
      ...
      <div className="z-10 shadow-input h-auto mx-auto w-full max-w-5xl rounded-none p-4 md:rounded-2xl md:p-8 backdrop-blur-sm bg-sky-900/20 border border-blue-950/20 flex items-center justify-center flex-col overflow-y-auto max-h-[80vh]">
          ...
          <form className="my-8 space-y-6">
            ...
            <button
              ...
              className={cn(
                ...
                "bg-gradient-to-br from-orange-400 to-blue-600 opacity-50 cursor-not-allowed"
              )}
            >
              Submit
            </button>
